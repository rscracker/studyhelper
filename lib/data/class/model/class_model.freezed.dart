    ...
    return _then(_value.copyWith(
      ...
      teacherId: teacherId == freezed
          ...
          : teacherId // ignore: cast_nullable_to_non_nullable
              as String,
      parentsId: parentsId == freezed
          ? _value.parentsId
          : parentsId // ignore: cast_nullable_to_non_nullable
              as List<String>,
...
/// @nodoc
@JsonSerializable()
class _$_ClassModel implements _ClassModel {
  _$_ClassModel(
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _ClassModel &&
            ...
            (identical(other.parentsId, parentsId) ||
                const DeepCollectionEquality()
                    .equals(other.parentsId, parentsId)) &&
